...
function! write#start(bang)
	setlocal spell wrap display+=lastline nolist linebreak foldcolumn=12 noruler colorcolumn="" 
    hi FoldColumn ctermbg=none guibg=background
...
function! write#stop()
	...
	setlocal spell< wrap< display< list< linebreak< ruler< colorcolumn< foldcolumn< ruler
	let b:writing=0
